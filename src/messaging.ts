...
export class Messenger {
    ...
    public sendWelcomeMessage(senderID: string) {
        ...
        this.sendBasicResponse(senderID,
            "Hello, welcome to Coding For Everyone! " +
    ...
    public sendHelpMessage(senderID: string) {
        ...
        this.sendBasicResponse(senderID,
            "Please type 'tutorial' for a tutorial recommendation, " +
    ...
    public sendReadyMessage(senderID: string) {
        ...
        this.sendBasicResponse(senderID, "Great, you're all set!");
    }

    public sendGenericErrorMessage(senderID: string) {
        trace("Messenger.sendGenericErrorMessage");
        this.sendBasicResponse(senderID, "Sorry, something went wrong!");
    }

    public sendNoAttachmentsMessage(senderID: string) {
        trace("Messenger.sendNoAttachmentsMessage");
        this.sendBasicResponse(senderID, "Sorry, we don't accept attachments!");
    }
    ...
    public sendNoResourceFoundMessage(senderID: string) {
        ...
        this.sendBasicResponse(senderID,
            "Sorry, it looks like we don't have any resources for you right now. " +
    ...
    public sendContribMessage(senderID: string) {
        ...
        this.sendBasicResponse(senderID,
            "For details on how to add new articles, " +
    ...
    public sendInvalidTypeMessage(senderID: string) {
        ...
        this.sendBasicResponse(senderID,
            "Sorry, that's not a valid resource type!");
    }
    ...
    private sendBasicResponse(senderID: string, text: string) {
        trace("Messenger.sendBasicResponse");
        this.send({
            type: MessagingType.Response,
            recipient: senderID,
            body: {
